...
# 新项目 / 未在卡片上改时的默认成片时长（分钟），须与 src.style_config.DEFAULT_STORY_DURATION_MINUTES 一致
DEFAULT_SYNOPSIS_DURATION_MINUTES = 6.0
DEFAULT_DURATION_SECONDS = int(round(DEFAULT_SYNOPSIS_DURATION_MINUTES * 60))
